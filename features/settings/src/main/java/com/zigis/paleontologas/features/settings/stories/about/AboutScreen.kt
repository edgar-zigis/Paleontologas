...
import com.zigis.paleontologas.features.settings.stories.about.list.AboutListItemView
...
private fun AboutScreenUiImplementation(
    ...
    sendIntent: (AboutScreenIntent) -> Unit?
) {
    ...
    NavigableScaffold(
        ...
        onBack = {
            sendIntent(AboutScreenIntent.InvokeBack)
        }
    ) {
        Column(
            modifier = Modifier
